...
paymentsRoutes.post('/initialize', rejectPriceFields, validate(checkoutSchema), asyncHandler(async (req, res, next) => {
  try {
...
paymentsRoutes.get('/verify/:reference', asyncHandler(async (req, res, next) => {
  try {
