    ...
    <div className="w-full">
      ...
      <div className="flex flex-col items-center justify-between border-t border-[#e5e2dd] pt-6 md:flex-row">
        ...
        <div className="mt-4 flex items-center gap-6 md:mt-0">
          <a href="https://www.instagram.com/be_bisile/" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 font-inter text-xs font-light uppercase tracking-[0.14em] text-primary/45 transition-colors hover:text-accent" aria-label="BISILE Instagram">
            <Instagram size={17} strokeWidth={1.2} /> Instagram
          </a>
          <a href="https://za.pinterest.com/be_bisile/" target="_blank" rel="noreferrer" className="font-inter text-xs font-light uppercase tracking-[0.14em] text-primary/45 transition-colors hover:text-accent" aria-label="BISILE Pinterest">
            Pinterest
          </a>
        </div>
      </div>
