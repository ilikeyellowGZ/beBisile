export const catalog = {
  ...
  'plucking-straightening': { name: 'Plucking & Straightening', price: 200 },
  'plucking-curl-activation': { name: 'Plucking & Curl Activation', price: 270 },
  ...
  'full-laundry-straight': { name: 'Wig Wash, Plucking, & Straightening', price: 390 },
  'full-laundry-curls': { name: 'Wig Wash, Plucking, & Curls Activation', price: 420 },
  'full-laundry-custom-part': { name: 'Wig Wash, Plucking, Custom Parting, & Straighten / Curl Activation', price: 590 },
};
